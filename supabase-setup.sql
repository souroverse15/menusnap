-- MenuSnap Database Setup for Supabase
...
CREATE TABLE IF NOT EXISTS cafe_applications (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id TEXT NOT NULL, -- Changed to TEXT to match users.id
    ...
    admin_notes TEXT,
    reviewed_by TEXT, -- Changed to TEXT to match users.id
...
CREATE TABLE IF NOT EXISTS notifications (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id TEXT, -- Changed to TEXT to match users.id
...
CREATE TABLE IF NOT EXISTS support_tickets (
    ...
    assigned_to TEXT, -- Changed to TEXT to match users.id
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
-- Success message
SELECT 'MenuSnap database schema created successfully! 🎉' as result;
